...
func newRoot(version string) *cobra.Command {
	...
	root.AddCommand(indexCmd(), searchCmd(), mcpCmd(version), serveCmd(), installCmd(), doctorCmd(), newCmd(), codexCmd(), resetCmd(), syncCmd(), updateCmd(version), digestCmd(), notifyCmd())
	return root
}
