...
- **Phase 4 Stage 3 release** (deferred until system testing is further along: tagged release with cross-compiled binaries + a Homebrew tap so `command: hebb` resolves on PATH).
